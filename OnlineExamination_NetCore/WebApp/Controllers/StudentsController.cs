    ...
    public class StudentsController : Controller
    {
        ...
        public IActionResult AttendExam()
        {
            ...
            if (sessionObj != null)
            {
                ...
                var todayExam = _examService.GetAllExams().Where(a => a.StartDate == DateTime.Today.Date).FirstOrDefault();
                if (todayExam == null)
                ...
                else
                {
                    ...
                    {
                        model.QnAs = _qnAService.GetAllQnAByExamId(todayExam.Id).ToList();
        ...
        public IActionResult Profile([FromForm] StudentViewModel studentViewModel)
        {
            ...
            if (studentViewModel.CVFileName != null)
        ...
        private string SaveFile(string path, IFormFile pictureFile)
        {
            ...
            var filename = Guid.NewGuid().ToString() + "." + pictureFile.FileName.Split('.')[pictureFile.FileName.Split('.').Length - 1];
